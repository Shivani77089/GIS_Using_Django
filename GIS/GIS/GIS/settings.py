...
SECRET_KEY = 'django-insecure-dev6u!wq1xr+u*g$_6+8$w$g+f4e)@9m%-eoljhsml9eityt5w'
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        'NAME': 'ATMS',
        # 'HOST': 'your_server_name_or_ip',  # Can be omitted if local
        # 'PORT': '',  # Can be omitted if using the default port
